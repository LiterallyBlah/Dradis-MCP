...
export function loadConfig(): Config {
  ...
  console.log("📋 Environment variables status:", {
    DRADIS_URL: config.DRADIS_URL ? "✅ Set" : "❌ Missing",
    DRADIS_API_TOKEN: config.DRADIS_API_TOKEN ? "✅ Set" : "❌ Missing",
    DRADIS_DEFAULT_TEAM_ID: config.DRADIS_DEFAULT_TEAM_ID
      ? `✅ ${config.DRADIS_DEFAULT_TEAM_ID}`
      : "⚠️ Not set",
    DRADIS_DEFAULT_TEMPLATE_ID: config.DRADIS_DEFAULT_TEMPLATE_ID
      ? `✅ ${config.DRADIS_DEFAULT_TEMPLATE_ID}`
      : "⚠️ Not set",
    DRADIS_DEFAULT_TEMPLATE: config.DRADIS_DEFAULT_TEMPLATE
      ? `✅ ${config.DRADIS_DEFAULT_TEMPLATE}`
      : "⚠️ Not set",
    DRADIS_VULNERABILITY_PARAMETERS: config.DRADIS_VULNERABILITY_PARAMETERS
      ? `✅ ${config.DRADIS_VULNERABILITY_PARAMETERS}`
      : "⚠️ Not set",
  });
